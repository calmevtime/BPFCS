...
rsnr_dl = zeros(mdivision,length(1:floor(samplesTrain / 10)));
cr_dl = zeros(mdivision,length(1:floor(samplesTrain / 10)));
prd_dl = zeros(mdivision,length(1:floor(samplesTrain / 10)));
sparsity_dl = zeros(mdivision,length(1:floor(samplesTrain / 10)));
basis = cell(mdivision,length(1:floor(samplesTrain / 10)));
R1 = cell(mdivision,length(1:floor(samplesTrain / 10)));
% R2 = cell(mdivision,length(1:floor(samplesTrain / 10)));
alpha = cell(mdivision,length(1:floor(samplesTrain / 10)));
reconSig = cell(mdivision,length(1:floor(samplesTrain / 10)));
...
filename = sprintf('./Results/m%d_batchsize%d_lambda%.2f.mat', mdivision, 10, 0.10);
save(filename)
