...
load ../Results/preDCT/sweeplambda_PreDCT_batchsize50.mat normErr
...
filename = sprintf('../Results/preDCT/demoSweepDctPre_m%d_batchsize%d.mat', mdivision, batchsize);
save(filename,'-v7.3');
...
% plotRSNR_Sparsity(dateToday, 'preDCT', mdivision, batchsize, samplesTrain, n_dl, rsnr_dl, rsnr_thres, sparsity_thres, lambda);
