...
load ../Results/withoutPre/sweeplambda_WithoutPre_batchsize50.mat  normErr
...
filename = sprintf('../Results/withoutPre/demoSweepWithoutPre_m%d_batchsize%d.mat', mdivision, batchsize);
save(filename,'-v7.3');
...
% plotRSNR_Sparsity(dateToday, 'withoutPre', mdivision, batchsize, samplesTrain, n_dl, rsnr_dl, rsnr_thres, sparsity_thres, lambda);
