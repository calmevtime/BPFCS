...
path_matlab='C:\Program Files\MATLAB\R2014a\bin';
...
if strcmp(compiler,'gcc') 
    if linux || mac
       ...
       path_to_compiler='C:\cygwin64\bin';
       path_to_compiler_libraries='C:\cygwin64\lib\gcc\x86_64-pc-cygwin\4.9.2';
    end
...
for k = 1:length(COMPILE),
    ...
    if windows
       str = ['-g ' str ' -outdir ' out_dir, ' ' DEFS ' ' links_lib ' OPTIMFLAGS="' compile_flags '" ']; 
    else
