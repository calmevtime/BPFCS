...
% delete(poolobj)
% 
% filename = sprintf('./Results/sweeplambda_PreFilter_m%d_batchsize%d.mat', mdivision, batchsize);
% save(filename,'-v7.3');
...
% % % % % % % % % % % % % % % % % % % % % % % % % % %
dateToday = date;
plotRSNR(dateToday, mdivision, batchsize, samplesTrain, n_dl, rsnr_dl, prd_dl, sparsity_dl, sweepParam);
